...
module.exports = { session: process.env.SESSION_ID || 'corazon,
    PREFIXE: process.env.PREFIX || "+",
    GITHUB : process.env.GITHUB|| 'https://github.com/sime-o/Simeo-MD',
    OWNER_NAME : process.env.OWNER_NAME || "CORAZON",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "255683530005",  
    ...
    URL: process.env.URL || "https://https://files.catbox.moe/4231aa.jpg",  
   ...
   GREET_MSG: process.env.GREET_MSG || "Huskii am unavailable mzee 😂",               
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || 'viewed by Corazon md',   
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || 'no',
    AUTOBIO: process.env.AUTOBIO || 'yes',       
    ANTICALL_MSG : process.env.ANTICALL_MSG || 'call declined',             
    GURL: process.env.GURL  || "https://whatsapp.com/channel/0029Vaan9TF9Bb62l8wpoD47",
    EVENTS :process.env.EVENTS || "yes",
    CAPTION : process.env.CAPTION || "CORAZON-MD",
    BOT : process.env.BOT_NAME || 'CORAZON_MD',
